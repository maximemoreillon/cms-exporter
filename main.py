...
# def find_image_manager_images(content):
#     url_pattern = r"https?://(?:[a-zA-Z]|[0-9]|[$-_@.&+]|[!*\\(\\),]|(?:%[0-9a-fA-F][0-9a-fA-F]))+|(?:www\.)(?:[a-zA-Z]|[0-9]|[$-_@.&+]|[!*\\(\\),]|(?:%[0-9a-fA-F][0-9a-fA-F]))+"
#     urls = re.findall(url_pattern, content)
#     for url in urls:
#         if url.startswith("https://img.maximemoreillon.com"):
#             print(url)
...
def process_content(content):
    ...
    # find_image_manager_images(content)
...
with GraphDatabase.driver(NEO4J_URI, auth=(NEO4J_USERNAME, NEO4J_PASSWORD)) as driver:
    with driver.session() as session:
        ...
        # NOTE: there is only one record for this query
        ...
        print("Records processing finished")
